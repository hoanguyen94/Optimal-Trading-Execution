...
8. Run SimulationFinal.py to simulate data
9. Run Training - Sim.py to train the model with simulated data
10. Run Benchmark.py to estimate performance of benchmark strategies
11. Run Performance.py to extract the results of Q-learning policies with learning rate 0.1
